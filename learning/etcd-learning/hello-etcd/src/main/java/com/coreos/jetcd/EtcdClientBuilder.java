...
public class EtcdClientBuilder {
	 ...
	 *
	 * @param endpoints
	 *            etcd server endpoints, at least one
	 * @return this builder to train
	 * @throws NullPointerException
	 *             if endpoints is null or one of endpoint is null
	 * @throws IllegalArgumentException
	 *             if endpoints is empty or some endpoint is invalid
	 */
	 ...
	 *             As network reason, wrong address
	 * @throws AuthFailedException
	 *             This may be caused as wrong username or password
	 */
