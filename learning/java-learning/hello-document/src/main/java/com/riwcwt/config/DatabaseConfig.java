...
@ComponentScan(basePackages = { "com.riwcwt.application.service" })
@MapperScan(value = { "com.riwcwt.application.mapper" }, sqlSessionFactoryRef = "sqlSessionFactory")
public class DatabaseConfig {
	...
	public DataSource dataSource() throws SQLException {
		...
		dataSource.setMaxActive(env.getProperty("jdbc.max.active", Integer.class));
		dataSource.setMaxWait(env.getProperty("jdbc.max.wait", Long.class));
